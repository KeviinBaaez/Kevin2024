...
namespace Kevin2024.Servicios.Interfaces
{
    public interface IServiciosEmpleados
    {
        ...
        int GetCantidad(Func<EmpleadosListDto, bool>? filter, TiposDeDatos? generoFiltro = null);
        Empleados? GetEmpleadoPorId(int empleadoId);
        List<EmpleadosListDto>? GetLista(int currentPage, int pageSize, Orden orden, Func<EmpleadosListDto, bool>? filter, TiposDeDatos? generoFiltro = null);
